        ...
        <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            @php
                $features = [
                    ...
                    ['Competitor Watch', 'tracker', 'Add rival stores and see their mention rate next to yours. Know exactly whose content is winning the AI answer.'],
                    ...
                    ['Content Calendar', 'content', 'Schedule blog posts in advance and get AI-powered content ideas. Posts auto-publish to your Shopify blog at the scheduled time.'],
                    ...
                    ['Product Optimizer', 'optimizer', 'Rewrite product descriptions to be AI-citation-friendly. One-click optimize all products with structured specs, ₹ pricing and FAQ sections.'],
                    ['AI Shopping Feed', 'feed', 'Generate a structured product feed for ChatGPT Shopping, Gemini Shopping and Perplexity Shopping. Your products get recommended by AI.'],
                    ...
                    ['llms.txt + robots.txt', 'llms', 'AI reading list and crawler rules for GPTBot, ClaudeBot, PerplexityBot, Google-Extended & more — served from a public URL AI crawlers can access.'],
                    ['Instant Indexing (IndexNow)', 'indexnow', 'Notify Bing, Yandex, Seznam and Naver about new or updated pages instantly. No waiting for crawlers — they get notified within seconds.'],
                    ['Brand Signals', 'brand', 'Analyze your brand presence across the web. Check Organization schema, social media, search presence and store branding consistency.'],
                    ['Speed Analysis', 'speed', 'Google PageSpeed Insights integration. Check Core Web Vitals (FCP, LCP, CLS), performance score, and get top 5 opportunities to improve.'],
                    ...
                    ['GA4 Data API', 'attribution', 'AI-sourced sessions, transactions and purchase revenue straight from Google Analytics 4 — just enter your Property ID.'],
