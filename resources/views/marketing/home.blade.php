        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-14">
                @foreach ([
                    ...
                    ['Content Calendar', 'Schedule blog posts in advance and get AI-powered content ideas. Posts auto-publish to your Shopify blog at the scheduled time.', '<path d="M8 2v4m8-4v4M3 10h18M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/>'],
                    ['Product Optimizer', 'Rewrite product descriptions to be AI-citation-friendly. One-click optimize all products with structured specs, ₹ pricing and FAQ sections.', '<path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z"/>'],
                    ['AI Shopping Feed', 'Generate a structured product feed for ChatGPT Shopping, Gemini Shopping and Perplexity Shopping. Your products get recommended by AI.', '<path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/>'],
                    ['Instant Indexing', 'Notify Bing, Yandex, Seznam and Naver about new or updated pages instantly via IndexNow. No waiting for crawlers.', '<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>'],
                    ['Brand Signals', 'Analyze your brand presence across the web. Check Organization schema, social media, search presence and store branding consistency.', '<path d="M12 2l8 4v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6l8-4z"/>'],
                    ['Speed Analysis', 'Google PageSpeed Insights integration. Check Core Web Vitals (FCP, LCP, CLS) and get top 5 opportunities to improve performance.', '<path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="M12 6v6l4 2"/>'],
                    ...
                    ['GA4 Data API', 'AI-sourced sessions, transactions and purchase revenue straight from Google Analytics 4 — just enter your Property ID.', '<path d="M9 19v-6m4 6V9m4 10V5M5 19v-3"/>'],
