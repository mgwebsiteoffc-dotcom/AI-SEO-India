...
Route::prefix('admin')->middleware('admin.guard')->group(function () {
    ...
    Route::post('/stores/{store}/toggle-custom', [\App\Http\Controllers\AdminController::class, 'toggleCustom'])->name('admin.store.toggle-custom');
...
Route::prefix('api')->middleware(VerifyShopifySession::class)->group(function () {
    ...
    Route::post('/product-optimizer/optimize-all', [ApiController::class, 'optimizeAllProducts']);
    Route::get('/product-optimizer/pending', [ApiController::class, 'pendingOptimizations']);
    Route::post('/product-optimizer/approve', [ApiController::class, 'approveOptimization']);
    Route::get('/shopping-feed', [ApiController::class, 'shoppingFeed']);
    Route::get('/content/calendar', [ApiController::class, 'contentCalendar']);
